  ...
  return (
    <section id="home" className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-40 right-32 w-24 h-24 bg-cyan-500/10 rounded-full blur-xl animate-float" style={{ animationDelay: '2s' }} />
        <div className="absolute bottom-32 left-32 w-40 h-40 bg-blue-500/10 rounded-full blur-xl animate-float" style={{ animationDelay: '4s' }} />
      </div>
      ...
      <div className="container mx-auto px-6 h-screen flex items-center justify-center relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl lg:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed animate-slide-up" style={{ animationDelay: '0.2s' }}>
            3rd year B.Tech CSE student at{' '}
            <span className="gradient-text font-semibold">Chandigarh University</span>
            {' '}| Aspiring{' '}
            <span className="gradient-text font-semibold">Fullstack Engineer</span>
          </p>
