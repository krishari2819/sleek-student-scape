...
export const ContactSection = () => {
  ...
  return (
    <section id="contact" className="section-padding bg-gradient-to-br from-purple-900/5 via-transparent to-cyan-900/5">
          ...
          <div className="space-y-8">
            ...
            <div className="glass p-8 rounded-2xl">
              ...
              >
                ...
                <span className="gradient-text font-semibold">Download Resume</span>
              </button>
            </div>
            ...
            <div className="glass p-8 rounded-2xl">
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    <h4 className="font-semibold group-hover:gradient-text transition-all duration-300">LinkedIn</h4>
                ...
                >
                  ...
                  <div>
                    <h4 className="font-semibold group-hover:gradient-text transition-all duration-300">GitHub</h4>
